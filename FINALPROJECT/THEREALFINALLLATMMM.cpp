            ...
            if (nasabahIndex >= 0)
            {
                ...
                while (isNasabah)
                {
                    ...
                    case 3:
                    {
                        ...
                        cout << "Setor tunai berhasil. Saldo Anda sekarang adalah Rp." << nasabah[nasabahIndex].saldo << endl
                             << endl;
                        break;
                    }
                    ...
                    case 4:
                    {
                        ...
                        if (nominalTransfer > 0 && nominalTransfer <= nasabah[nasabahPengirimIndex].saldo)
                        {
                            ...
                            cout << "Transfer Berhasil. Saldo Anda Kini: Rp." << nasabah[nasabahPengirimIndex].saldo << endl
                                 << endl;
                        }
                        else
                        {
                    ...
                    case 5:
                        system("cls");
                        cout << "Masuk Sebagai Nasabah" << endl
                             << endl;
                        cout << "Masukkan nomor rekening: ";
                        int nomorRekening;
                        cin >> nomorRekening;
