    ...
    do
    {
        ...
        for (Barang &b : gudang)
        {
            if (b.kode == barang.kode)
            {
                ...
                {
                    gotoxy(40, 3);
                    cout << "Jumlah pembelian melebihi stok barang" << endl;
                    getch();
                    return true;
                }
...
void pegawaiGudang()
{
    ...
    while (tekan != 13)
    {
        ...
        gotoxy(5, 9);
        panah(1, posisi);
        printf(" 1. Jumlah Pembelian");
        gotoxy(5, 10);
        panah(2, posisi);
        printf(" 2. Print Struk");
        gotoxy(5, 11);
        panah(3, posisi);
        printf(" 3. Keluar");
...
int main()
{
    ...
    Barang barang1 = {"001", "VGA", "", "", 1, 3000, 3000, 0};
    Barang barang2 = {"002", "CPU", "", "", 2, 2500, 2000, 0};
    Barang barang3 = {"003", "FAN", "", "", 3, 2000, 2500, 0};
